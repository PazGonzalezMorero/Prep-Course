...
function agregarPropiedad(objeto, property) {
  ...
  //si no sabemos el nombre de la propiedas del objeto que vamos a usar se pone: objeto.nombre ó objeto ["property"]
  //cuando nos llega por argumento se pone: objeto[property]
