...
function fizzBuzz(numero) {
  ...
  // ***** resulve primero lo mas largo porque si es verdadero ya se cierra, sino sigue analizanod ****
...
function operadoresLogicos(num1, num2, num3) {
  ...
  if (num1 < 0 || num2 < 0 || num2 < 0) {return "Hay negativos"} 
  else if (num1 === 0 || num2 === 0 || num3 === 0 ) {return "Error"}
  else if (num1 > num2 && num1 > num3 && num1 % 2 === 0) {return "Número 1 es mayor y positivo"}
